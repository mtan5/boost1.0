...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2018 at 03:07 AM
...
(61, 17, 2, 17, 2, '328.05', '2018-04-22', NULL, 'agent', 1),
...
(1, 'Mark', 'Sample', 'Longanillaz', '123456', '1984-01-18', '1058 Dugald Rd', 'Sample City', 'New Brunswick', 'R2J0H123', '2044303401', 'marktan@email.com', 8, 0, 0, 0, 0, 3, 'MT0106841', 1, '2018-04-11 00:00:00', NULL, 'admin', NULL),
...
INSERT INTO `tbl_policy_sold` (`policy_id`, `policy_number`, `company_id`, `product_id`, `date_purchased`, `annual_prem`, `monthly_prem`, `status`) VALUES
(17, 'PLCY015263', 2, 2, '2018-04-22', '540.00', '45.00', 1);
...
--
ALTER TABLE `tbl_commissions`
  MODIFY `comm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
