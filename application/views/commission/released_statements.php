...
<div class="container-fluid">	
	<div class="col-sm-12" style="padding-top:6%;">
		...
		<div class='row'>
			<div class="col-sm-12">			
				<div class="col-sm-3">Member: <?php echo form_dropdown("search_member", $member_list, $search_member,"class='form-control' id='member_list'"); ?></div>				
			...
			<tbody>
				...
				if(count($statement_list) > 0){	
					...
					foreach($statement_list as $statement){	
						echo "
							<tr>
								<td><button type='button' class='btn btn-warning btn-xs delete_statement' value='".$statement->id."'>DELETE</button></td>
								<td>".$statement->id."</td>
								<td><a href='".base_url()."documents/commission_statements/".$statement->file_name."' target='_blank'>".$statement->file_name."</a></td>
								<td>".$statement->first_name." ".$statement->last_name."</td>
